<template>
   <div class= "container mt-5">
         <div class="row justify-content-center ">
            <div class="col-md-8 mt-2 bg-light rounded">
                <div>
                ...
                <div class="form-group row mb-4" :class="{error: errors.has('name')}" >
                 ...
                 <label for="establishmentEmail" class="col-sm-3 col-form-label">Establishment Email</label>
                  <input type="text" name="establishmentEmail" id="establishmentEmail" class="form-control p-4"  v-validate="'required|email'" v-model="establishmentEmail">
                 ...
                 <label for="price" class="col-sm-4 col-form-label" >Price per person per night ($)</label>
                 ...
                 <label for="maxGuests" class="col-sm-2 col-form-label" >Max guests</label>
                  <input type="number" name="maxGuests" class="form-control p-4" id="maxGuests">
                </div>
                 <div class="form-group row mb-4"  >
                 <label for="googleLat" class="col-sm-4 col-form-label" >Google Coordinates Latitude</label>
                  <input type="text" name="googleLat"  class="form-control p-4" id="googleLat" >
                </div>
                 <div class="form-group row mb-4" >
                 <label for="googleLong" class="col-sm-4 col-form-label" >Google Coordinates Longitude</label>
               ...
               <div class=" form-group form-check form-check-inline mb-3">
                <label for="selfCatering p-4">Self-catering</label>
                  ...
                  <input type="radio" id="false" name="selfCatering" class="vform-group form-check-input"  value="false" >
               </div>
                 <div class="form-group row mb-4">
